...
// 방법 1
let inputArr1 = "hqllo my namq is hyqwon".split("");

for(index in inputArr1) {
    if(inputArr1[index] == 'q') {
        inputArr1[index] = 'e';
    }
}

console.log(inputArr1.join(""));

// 방법 2
let inputArr2 = "hqllo my namq is hyqwon".split("q").join("e");
